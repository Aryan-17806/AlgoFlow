  ...
  return (
    <div style={styles.container}>
      ...
      <input
        ...
        placeholder="Search"
      />
      <button style={styles.button} onClick={() => search(searchInput)} disabled={isSearching}>
        Search
      </button>
      <button style={styles.button} onClick={stop} disabled={!isSearching}>
        Stop
      </button>
      ...
      <input
        ...
        placeholder="Add"
      />
      <button style={styles.button} onClick={() => addNode(addInput)} disabled={isSearching}>
        Add Node
      </button>
